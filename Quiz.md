...
4) O que é lexema?
Lexema são sequências significativas agrupadas por um analisádor léxico que lê um fluxo de caracteres e os agrupa em lexemas. (CURIOSIDADE: Para cada lexema, o analisador léxico produz como saída um token). ~Raquel Sales
